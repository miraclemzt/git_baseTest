...
public final class The {
    ...
    public static class API {
        private final static String ACCESS = "testid";
        private final static String SECRET = "testsecret";
        private final static String END_POINT = "https://ecs-cn-hangzhou.aliyuncs.com/";
        private final static String API_VERSION = "2014-05-26";
